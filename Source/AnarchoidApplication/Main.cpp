...
VIMPORT IVisPlugin_cl* GetEnginePlugin_AnarchoidPlugin();
VIMPORT IVisPlugin_cl* GetEnginePlugin_vScaleformPlugin(); 

class AnarchoidApplicationClass : public VAppImpl
{
public:
  AnarchoidApplicationClass() {}
  virtual ~AnarchoidApplicationClass() {}
...
VAPP_IMPLEMENT_SAMPLE(AnarchoidApplicationClass);

void AnarchoidApplicationClass::SetupAppConfig(VisAppConfig_cl& config)
{
  ...
  config.m_videoConfig.m_szWindowTitle = "Anarchoid";
...
void AnarchoidApplicationClass::PreloadPlugins()
{
  ...
  VISION_PLUGIN_ENSURE_LOADED(AnarchoidPlugin);
...
//---------------------------------------------------------------------------------------------------------
void AnarchoidApplicationClass::AfterSceneLoaded(bool bLoadingSuccessful)
{
...
//---------------------------------------------------------------------------------------------------------
bool AnarchoidApplicationClass::Run()
{
  return true;
}

void AnarchoidApplicationClass::DeInit()
{
  // De-Initialization
  // [...]
}
