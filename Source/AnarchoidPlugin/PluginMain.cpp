...
//============================================================================================================
class AnarchoidPluginClass : public IVisPlugin_cl
{
public:
  ...
  {
    return "AnarchoidPlugin";  // must match DLL name
  }
};

//  global plugin instance
AnarchoidPluginClass g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_AnarchoidPlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_AnarchoidPlugin();}
...
void AnarchoidPluginClass::OnInitEnginePlugin()
{
  hkvLog::Info("AnarchoidPluginClass:OnInitEnginePlugin()");
...
void AnarchoidPluginClass::OnDeInitEnginePlugin()
{
  hkvLog::Info("AnarchoidPluginClass:OnDeInitEnginePlugin()");
